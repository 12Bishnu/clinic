...
import { ShoppingCart, Search, Plus, Minus, Upload } from 'lucide-react';
import { useCart } from '../contexts/CartContext';
import { useAuth } from '../contexts/AuthContext';
import { useToast } from '../contexts/ToastContext';
import { Medicine } from '../types/medicine';
import { pharmacyOrders, medicines, prescriptions } from '../services/api';
...
export default function EPharmacyPage() {
  ...
  const handlePrescriptionUpload = async (e: React.FormEvent) => {
    ...
    if (!prescriptionFile) {
      showToast('Please select a prescription file', 'error');
      return;
    }
    ...
    try {
      ...
      formData.append('patient_name', user.name);
      formData.append('patient_phone', user.phone);

      await prescriptions.upload(formData);
      showToast('Prescription uploaded successfully! We will process your order soon.', 'success');
              ...
              <form onSubmit={handlePrescriptionUpload} className="space-y-6">
                <div>
                  ...
                  <p className="mt-2 text-sm text-gray-500">
                    Upload a clear image of your prescription (JPG, PNG)
                  </p>
                </div>
                ...
                <div className="flex justify-end space-x-3">
                  ...
                  <button
                    ...
                    className={`glass-button ${(uploadLoading || !prescriptionFile) ? 'opacity-50 cursor-not-allowed' : ''}`}
                  >
